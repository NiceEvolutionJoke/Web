...
<div class="login-page">
    <div class="page-header clear-filter" filter-color="green">
      <div class="page-header-image" style="background-image:url('../assets/img/blurred-image-1.jpg');">
      </div>
			...
			<div class="tab-pane active" id="login" role="tabpanel">
				<form action="index.php" method="POST" class="clearfix">
				   ...
				   <div class="row">
					...
					<div class="g-recaptcha" style="width: 304px; margin: 0 auto;" data-theme="dark" data-sitekey="6LdET88ZAAAAALrTQWWVPDJeGa7GRm3Uw_5TT2HS"></div>
					</div>
