...
//	  require_once "classes/recaptchalib.php";
	  $privatekey = "6LdET88ZAAAAAGP4Z1ThjWRY3mnbhWvXfNFFLKFS";
...
*/
  ...
  <script src="assets/js/libraries/jquery.nicescroll.min.js" type="text/javascript"></script>
  <script src="assets/js/libraries/jquery.tablesort.min.js" type="text/javascript"></script>
  <script src="assets/js/libraries/bootstrap.min.js" type="text/javascript"></script>
